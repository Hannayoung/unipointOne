...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Academy Manage</a>
            </div>
            <form class="form-inline">
            <div class="row">
				<div class="form-group col-sm-8 col-md-3 col-lg-3">
					<label for="InputId" class="white">ID</label>
	               <input type="text" class="form-control" placeholder="ID" id="member_id" required data-validation-required-message="Please enter your name.">
	            </div>
            	<div class="form-group col-sm-5 col-md-3 col-lg-4">
				   <label for="InputPassword" class="white">Password</label>
				   <input type="password" class="form-control" id="member_pw" placeholder="Password">
 				</div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#services">학생 관리</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#portfolio">성적 관리</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#about">학습 관리</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#team">출결 관리</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#contact">수납 현황</a>
                    </li>
                </ul>
    ...
    <header>
        ...
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">학원관리시스템</div>
            </div>
        </div>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="resources/img/portfolio/main1.png" alt="main1">
      <div class="carousel-caption">
   
      </div>
    </div>
    <div class="item">
      <img src="resources/img/portfolio/main2.jpg" alt="main2">
      <div class="carousel-caption">
